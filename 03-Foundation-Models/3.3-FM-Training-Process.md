...
Training involves several stages to create or adapt an FM[cite: 165]:
...
Fine-tuning adapts the model's weights to improve performance on a specific task[cite: 167]:
...
Data preparation is critical and requires careful consideration[cite: 168]:
...
* **RLHF (Reinforcement Learning from Human Feedback):** A method where human preferences (ratings of model responses) are used to further adjust the model's weights, making its outputs more helpful and harmless[cite: 168].
